        ...
        <tbody>
          {Object.keys(classWiseGammaStats).map((alcoholClass) => (
            <tr key={alcoholClass}>
              ...
              <td>{classWiseGammaStats[alcoholClass].mean || 'Calculating...'}</td>
              <td>{classWiseGammaStats[alcoholClass].median || 'Calculating...'}</td>
              <td>{classWiseGammaStats[alcoholClass].mode || 'Calculating...'}</td>
            </tr>
          ))}
        </tbody>
      </table>
